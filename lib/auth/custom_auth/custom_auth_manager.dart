...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mentorBridgeAuthUserSubject.add(
      MentorBridgeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MentorBridgeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MentorBridgeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MentorBridgeAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    mentorBridgeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MentorBridgeAuthUser? currentUser;
