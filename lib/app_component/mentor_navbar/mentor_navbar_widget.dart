...
import 'mentor_navbar_model.dart';
export 'mentor_navbar_model.dart';

class MentorNavbarWidget extends StatefulWidget {
  const MentorNavbarWidget({
    super.key,
  ...
  @override
  State<MentorNavbarWidget> createState() => _MentorNavbarWidgetState();
}

class _MentorNavbarWidgetState extends State<MentorNavbarWidget>
    with TickerProviderStateMixin {
  late MentorNavbarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentorNavbarModel());
