...
export 'mentor_message_model.dart';

class MentorMessageWidget extends StatefulWidget {
  const MentorMessageWidget({super.key});

  @override
  State<MentorMessageWidget> createState() => _MentorMessageWidgetState();
}

class _MentorMessageWidgetState extends State<MentorMessageWidget> {
  late MentorMessageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentorMessageModel());
