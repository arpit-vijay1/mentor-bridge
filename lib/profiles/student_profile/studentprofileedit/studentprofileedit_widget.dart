...
import 'studentprofileedit_model.dart';
export 'studentprofileedit_model.dart';

class StudentprofileeditWidget extends StatefulWidget {
  const StudentprofileeditWidget({super.key});

  @override
  State<StudentprofileeditWidget> createState() =>
      _StudentprofileeditWidgetState();
}

class _StudentprofileeditWidgetState extends State<StudentprofileeditWidget> {
  late StudentprofileeditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentprofileeditModel());
                          ...
                          children: [
                            Align(
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                future: GetDataGroup.studentCall.call(
                                            ...
                                            Align(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                  ...
                                                  text: GetDataGroup.studentCall
                                                      .name(
                                                    maxWidthStudentResponse
                                                        .jsonBody,
                                                  ),
                                                ),
                                                focusNode:
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.apistudentprofileedit =
                                await UpdateDataGroup.updateStudentCall.call(
                              id: FFAppState().UID,
                              ...
                              branch: _model.yearValue,
                              sec: _model.sectionValue,
                            );
                            if ((_model.apistudentprofileedit?.succeeded ??
                                true)) {
